                ...
                <div class="projects__menu-item">
                    <div class="projects__menu-item-top">
                        <a href="<?= $value['ссылка']['url'] ?>">
                            <img src="<?= $value['изображение']['url'] ?>" alt="<?= $value['ссылка']['title'] ?>">
                        ...
                        foreach ($popularProject as $key => $value) : ?>
                            ...
                            <div class="popular__projects-item">
                                ...
                                <div class="popular__projects-item-img">
                                    <img src="<?php echo $img[0]['изображение'][0]['url'] ?>" alt="">
                ...
                <div class="col-md-12">
                    ...
                    <div uk-lightbox="animation: slide" id="gallery">
                        ...
                        foreach ($galery as $key => $value) : ?>
                            ...
                            <div>
                                <a class="uk-inline" href="<?php echo $value['изображение']['url'] ?>" <?php if ($value['изображение']['caption']) : ?>data-caption="<?php echo $value['изображение']['caption'] ?> <?php endif; ?>">
                                    <img src="<?php echo $value['изображение']['url'] ?>" alt="<?php echo $value['изображение']['caption'] ?>">
                                </a>
                            </div>
                                ...
                                foreach ($principles as $key => $value) : ?>
                                    ...
                                    <div class="principles_carousel_item">
                                        ...
                                        <div class="principles_carousel_item_content">
                                            <span><?php echo $value['этап'] ?></span><h3><?php echo $value['название_этапа'] ?></h3>

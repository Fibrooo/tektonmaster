        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="project_heading">
                    <h1>Строительство каменных домов "под ключ"</h1>
                    <h2>В этом разделе собраны типовые проекты <strong>каменных домов</strong>.</h2>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="houses_category_item">
                        ...
                        <div class="houses_category_item_info">
                            ...
                            <p>От <?php echo $data_price['теплый_контур']?> млн. руб.</p>
                        </div>
